...
public class RemoteBackup {
    ...
    private void signIn() {
        ...
        activity.startActivityForResult(GoogleSignInClient.getSignInIntent(), BackupActivity.REQUEST_CODE_SIGN_IN);
    }
    ...
    private void startDriveBackup() {
        mDriveResourceClient
                ...
                .addOnFailureListener(
                        e -> Log.w(TAG, activity.getString(R.string.failed_to_create_new_contents), e));
    }
    ...
    private Task<Void> createFileIntentSender(DriveContents driveContents) {
        ...
        return mDriveClient
                ...
                .continueWith(
                        task -> {
                            activity.startIntentSenderForResult(task.getResult(), BackupActivity.REQUEST_CODE_CREATION, null, 0, 0, 0);
                            return null;
                        });
    }
    ...
    private void startDriveRestore() {
        pickFile()
                ...
                .addOnFailureListener(activity, e -> {
                    Log.e(TAG, activity.getString(R.string.no_file_selected), e);
                });
    }
        ...
        openFileTask
                .continueWithTask(task -> {
                    ...
                    try {
                        ...
                        Toasty.success(activity, R.string.database_Import_completed, Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(e -> {
                    Log.e(TAG, activity.getString(R.string.unable_to_read_contents), e);
                    Toast.makeText(activity, R.string.error_on_import, Toast.LENGTH_SHORT).show();
                });
    }
        ...
        mDriveClient
                ...
                .continueWith((Continuation<IntentSender, Void>) task -> {
                    activity.startIntentSenderForResult(
                            task.getResult(), BackupActivity.REQUEST_CODE_OPENING, null, 0, 0, 0);
                    return null;
                });
    ...
    private Task<DriveId> pickFile() {
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        ...
                        .setActivityTitle(activity.getString(R.string.select_database_file))
                        .build();
