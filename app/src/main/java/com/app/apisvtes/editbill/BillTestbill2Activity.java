...
public class BillTestbill2Activity extends AppCompatActivity {
    String txtKheiID="";
    String strBarcode="";
    TextView editText;
...
//        textSEWER1= views.findViewById(R.id.text_SEWER1);
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(BillTestbill2Activity.this);
        databaseAccess.open();
...
//                        txt_PREVDATE.setText(dt);
                    ...
                    Data = databaseAccess.getRATEbb6();
                    if (Data.size() > 0) {
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    DatabaseAccess databaseAccesss = DatabaseAccess.getInstance(BillTestbill2Activity.this);
...
*/
                ...
                if(isconnected) {
                    Intent intent = new Intent(BillTestbill2Activity.this, PaymentActivity.class);
                    startActivity(intent);
                }else {
                    Toasty.error(BillTestbill2Activity.this, "ກະລຸນາເຊື່ອມຕໍ່ອີນເຕີເນັດ", Toast.LENGTH_SHORT).show();
                }
    ...
    private void doPhotoPrint() {
        ...
        photoPrinter.printBitmap("image.png_test_print", bitmap, new PrintHelper.OnPrintFinishCallback() {
            ...
            public void onFinish() {
                ...
                Toasty.success(BillTestbill2Activity.this, "ພິມສຳເລັດ", Toast.LENGTH_SHORT).show();
