...
public class BillTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billtest);
                ...
                try {
                    ...
                    if (productData.size() > 0) {
                      ...
                      //  textMret.setText(productData.get(0).get("Mrent"));
                        ...
                        double dsesewe = Double.valueOf(s1sewe);
                       ...
                       // String Arrears = productData.get(0).get("TOTALDUE");
                        ...
                        double rrears = Double.parseDouble(Arrears);
                       ...
                       //  double sumv = Double.parseDouble(totals);
                        ...
                        Double du = Double.parseDouble(f3.format(ab));
                        ...
                        cons = Double.valueOf(consumption);
                       // txtConsumption.setText(cons+" ມ³");
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (Get_Date.size() > 0) {
                        ...
                        Double talosd = Double.parseDouble(f3.format(dsese));
                    ...
                    DatabaseAccess databaseAccesss = DatabaseAccess.getInstance(BillTestActivity.this);
...
*/
                ...
                if(isconnected) {
                    if (pay.equals("1")){
                        Toasty.error(BillTestActivity.this, "ບີນນີ້ຊຳລະເງີນແລ້ວ!", Toast.LENGTH_SHORT).show();
                    }else if(pay.equals("0")){
                     //   Toasty.error(BillTestActivity.this, "ບີນນີ້ຊຳລະເງີນແລ້ວ!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(BillTestActivity.this, Payment2Activity.class);
                        startActivity(intent);
                    }

                }else {
                    Toasty.error(BillTestActivity.this, "ກະລຸນາເຊື່ອມຕໍ່ອີນເຕີເນັດ", Toast.LENGTH_SHORT).show();
                }
    ...
    private void doPhotoPrint() {
        ...
        photoPrinter.printBitmap("image.png_test_print", bitmap, new PrintHelper.OnPrintFinishCallback() {
            ...
            public void onFinish() {
                ...
                Toasty.success(BillTestActivity.this, "ພິມສຳເລັດ", Toast.LENGTH_SHORT).show();
