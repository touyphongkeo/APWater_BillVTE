package com.app.apisvtes.repayment;
...
import com.app.apisvtes.adapter.Receiptmetns_list_dapter;
import com.app.apisvtes.database.DatabaseAccess;
import com.app.apisvtes.tapwater.GpsTracker;
...
public class Repayment_list_Activity extends BaseActivity {
    ...
    Receiptmetns_list_dapter receiptmetns_list_dapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repaymnet_list);
        ...
        getSupportActionBar().setTitle("ຊຳລະເງີນຄ່ານ້ຳ");
        ...
        gpsTracker = new GpsTracker(Repayment_list_Activity.this);
        ...
        imgscancode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    DatabaseAccess databaseAccess = DatabaseAccess.getInstance(Repayment_list_Activity.this);
                    databaseAccess.open();
                    //get data from local database
                    String lt =flatitude.substring(0, 6);
                    String lng =flongitude.substring(0, 6);
                    List<HashMap<String, String>> searchExpenseList2;
                    searchExpenseList2 = databaseAccess.searchListrecept_listsbbbrepaymet(lt , lng,VillID);
                    ...
                    if (searchExpenseList2.size() <= 0) {
                        ...
                        receiptmetns_list_dapter = new Receiptmetns_list_dapter(Repayment_list_Activity.this, searchExpenseList2);
                        recyclerView.setAdapter(receiptmetns_list_dapter);
        ...
        try {
            ...
            databaseAccess.open();
            productData = databaseAccess.searchListreceipsnnbbrepaymet("",selectedCategoryID2.toString());
            ...
            if (productData.size() <= 0) {
                ...
                imgNoProduct.setVisibility(View.GONE);
                receiptmetns_list_dapter = new Receiptmetns_list_dapter(Repayment_list_Activity.this, productData);
                recyclerView.setAdapter(receiptmetns_list_dapter);
        ...
        etxtDistrict.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                categoryAdapter = new ArrayAdapter<String>(Repayment_list_Activity.this, android.R.layout.simple_list_item_1);
                categoryAdapter.addAll(categoryNames);

                AlertDialog.Builder dialog = new AlertDialog.Builder(Repayment_list_Activity.this);
                ...
                dialog_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        try {
                            ...
                            productData = databaseAccess.getAllWaterSSbbvvrepayment(selectedCategoryID2.toString());
        ...
        etxtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    ...
                    databaseAccess.open();
                    //get data from local database
                    searchExpenseList = databaseAccess.search_receipt_list_activityfffrepayment(s.toString());
                    ...
                    if (searchExpenseList.size() <= 0) {
                        ...
                        recyclerView.setVisibility(View.VISIBLE);
                        imgNoProduct.setVisibility(View.GONE);
                        receiptmetns_list_dapter = new Receiptmetns_list_dapter(Repayment_list_Activity.this, searchExpenseList);
                        recyclerView.setAdapter(receiptmetns_list_dapter);
