...
public class RillTestActivity extends AppCompatActivity {
    String txtKheiID="";
    String strBarcode="";
    TextView editText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rilltest);
...
//        textSEWER1= views.findViewById(R.id.text_SEWER1);
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(RillTestActivity.this);
        databaseAccess.open();
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (Get_Date.size() > 0) {
                        ...
                        textTotals.setText(f1.format(dsss));
                    ...
                    DatabaseAccess databaseAccesss = DatabaseAccess.getInstance(RillTestActivity.this);
...
*/
                ...
                if(isconnected) {
                     ...
                     //   Toasty.error(BillTestActivity.this, "ບີນນີ້ຊຳລະເງີນແລ້ວ!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(RillTestActivity.this, RepaymentActivity.class);
                        startActivity(intent);


                }else {
                    Toasty.error(RillTestActivity.this, "ກະລຸນາເຊື່ອມຕໍ່ອີນເຕີເນັດ", Toast.LENGTH_SHORT).show();
                }
    ...
    private void doPhotoPrint() {
        ...
        photoPrinter.printBitmap("image.png_test_print", bitmap, new PrintHelper.OnPrintFinishCallback() {
            ...
            public void onFinish() {
                ...
                Toasty.success(RillTestActivity.this, "ພິມສຳເລັດ", Toast.LENGTH_SHORT).show();
