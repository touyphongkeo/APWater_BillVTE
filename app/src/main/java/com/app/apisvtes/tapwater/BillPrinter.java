...
import com.app.apisvtes.utils.printerWordMng;
...
public class BillPrinter implements IPrintToPrinter {
    ...
    public BillPrinter(Context context, String shopName, String shopAddress, String shopEmail, String shopContact, String invoiceId, String orderDate, String orderTime, String customerName, String footer, double subTotal, double totalPrice, String tax, String discount, String currency) {
