...
public class Expensereport_listActivity extends BillActivity{
    ...
    Expensereport_listAdapter expensereport_listAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ໃບບີນແຈ້ງນ້ຳປະປາ");
        ...
        gpsTracker = new GpsTracker(Expensereport_listActivity.this);
        ...
        imgscancode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    DatabaseAccess databaseAccess = DatabaseAccess.getInstance(Expensereport_listActivity.this);
                    databaseAccess.open();
                    //get data from local database
                    String lt =flatitude.substring(0, 6);
                    String lng =flongitude.substring(0, 6);
                    List<HashMap<String, String>> searchExpenseList2;
                    searchExpenseList2 = databaseAccess.searchListexpent_list(lt , lng,VillID);
                    ...
                    if (searchExpenseList2.size() <= 0) {
                        ...
                        imgNoProduct.setImageResource(R.drawable.pos);

                    } else {

                        recyclerView.setVisibility(View.VISIBLE);
                        imgNoProduct.setVisibility(View.GONE);
                        expensereport_listAdapter = new Expensereport_listAdapter(Expensereport_listActivity.this, searchExpenseList2);
                        recyclerView.setAdapter(expensereport_listAdapter);
        ...
        try {
            ...
            databaseAccess.open();
            productData = databaseAccess.searchListexpent_list("",selectedCategoryID2.toString());
            ...
            if (productData.size() <= 0) {
                ...
                imgNoProduct.setVisibility(View.GONE);
                expensereport_listAdapter = new Expensereport_listAdapter(Expensereport_listActivity.this, productData);
                recyclerView.setAdapter(expensereport_listAdapter);
        ...
        etxtDistrict.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                categoryAdapter = new ArrayAdapter<String>(Expensereport_listActivity.this, android.R.layout.simple_list_item_1);
                categoryAdapter.addAll(categoryNames);

                AlertDialog.Builder dialog = new AlertDialog.Builder(Expensereport_listActivity.this);
                ...
                dialog_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        try {
                            ...
                            productData = databaseAccess.getAllWaterexpent_list(selectedCategoryID2.toString());
        ...
        etxtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try{
                    ...
                    databaseAccess.open();
                    //get data from local database
                    searchExpenseList = databaseAccess.search_receipt_list_activity(s.toString() , VillID.toString());
                    ...
                    if (searchExpenseList.size() <= 0) {
                        ...
                        recyclerView.setVisibility(View.VISIBLE);
                        imgNoProduct.setVisibility(View.GONE);
                        expensereport_listAdapter = new Expensereport_listAdapter(Expensereport_listActivity.this, searchExpenseList);
                        recyclerView.setAdapter(expensereport_listAdapter);
