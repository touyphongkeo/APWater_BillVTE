...
public class BillTestsActivity extends AppCompatActivity {
    String txtKheiID="";
    String strBarcode="";
    TextView editText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billtests);
...
//        textSEWER1= views.findViewById(R.id.text_SEWER1);
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(BillTestsActivity.this);
        databaseAccess.open();
...
*/
                    ...
                    Toast.makeText(BillTestsActivity.this, "", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (Get_Date.size() > 0) {
                        ...
                        String currentDates = new SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(new Date());
                        txt_PREVDATEss.setText(currentDates);
                        String currentDate = new SimpleDateFormat("MM/yyyy", Locale.getDefault()).format(new Date());
                        String strM4 = new SimpleDateFormat("MM", Locale.getDefault()).format( new Date());
                        String strM=new SimpleDateFormat("MM", Locale.getDefault()).format(new Date());
                        String strYear=new SimpleDateFormat("yyyy", Locale.getDefault()).format(new Date());
...
//                        txt_PREVDATEss.setText(dt);
                        ...
                        Double dseses = Double.parseDouble(s1se);
                    ...
                    DatabaseAccess databaseAccesss = DatabaseAccess.getInstance(BillTestsActivity.this);
                    ...
                    if (RATES.size() > 0) {
                        ...
                        if (cons<=5){
                            ...
                            txtConsumptionss.setText(f1.format(cons)+" ມ³");
                            String rate1 = RATES.get(0).get("RATE1");
...
*/
                ...
                if(isconnected) {
                    if (pay.equals("1")){
                        Toasty.error(BillTestsActivity.this, "ບີນນີ້ຊຳລະເງີນແລ້ວ!", Toast.LENGTH_SHORT).show();
                    }else if(pay.equals("0")){
                        Intent intent = new Intent(BillTestsActivity.this, Payment2Activity.class);
                        startActivity(intent);
                    }

                }else {
                    Toasty.error(BillTestsActivity.this, "ກະລຸນາເຊື່ອມຕໍ່ອີນເຕີເນັດ", Toast.LENGTH_SHORT).show();
                }
    ...
    private void doPhotoPrint() {
        ...
        photoPrinter.printBitmap("image.png_test_print", bitmap, new PrintHelper.OnPrintFinishCallback() {
            ...
            public void onFinish() {
                ...
                Toasty.success(BillTestsActivity.this, "ພິມສຳເລັດ", Toast.LENGTH_SHORT).show();
