...
import com.app.apisvtes.adapter.BillDetailsAdapter;
...
import com.app.apisvtes.utils.IPrintToPrinter;
import com.app.apisvtes.utils.PrefMng;
import com.app.apisvtes.utils.Tools;
import com.app.apisvtes.utils.WoosimPrnMng;
import com.app.apisvtes.utils.printerFactory;
...
public class BillDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(BillDetailsActivity.this, LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager); // set LayoutManager to RecyclerView

        recyclerView.setHasFixedSize(true);


        final DatabaseAccess databaseAccess = DatabaseAccess.getInstance(BillDetailsActivity.this);
        databaseAccess.open();
        ...
        if (orderDetailsList.isEmpty()) {
            ...
            Toasty.info(BillDetailsActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
        } else {
            billDetailsAdapter = new BillDetailsAdapter(BillDetailsActivity.this, orderDetailsList);
        ...
        btnThermalPrinter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Tools.isBlueToothOn(BillDetailsActivity.this)) return;


                PrefMng.saveActivePrinter(BillDetailsActivity.this, PrefMng.PRN_WOOSIM_SELECTED);

                //Pick a Bluetooth device
                Intent i = new Intent(BillDetailsActivity.this, PrintListActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(requestCode==REQUEST_CONNECT&&resultCode==RESULT_OK){
            try {
                ...
                String blutoothAddr = data.getExtras().getString(PrintListActivity.EXTRA_DEVICE_ADDRESS);
                //The interface to print text to thermal printers.
                IPrintToPrinter billPrinter = new BillPrinter(this,shop_name,shop_address,shop_email,shop_contact,order_id,order_date,order_time,shortText,longText,total_price,calculated_total_price,tax,discount,currency);
                //Connect to the printer and after successful connection issue the print command.
                mPrnMng = printerFactory.createPrnMng(this, blutoothAddr, billPrinter);
            } catch (Exception e){
