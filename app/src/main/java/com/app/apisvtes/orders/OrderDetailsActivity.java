package com.app.apisvtes.orders;
...
import com.app.apisvtes.adapter.OrderDetailsAdapter;
...
public class OrderDetailsActivity extends BaseActivity {
    ...
    //    templatePDF.addImageLogo2(BitmapFactory.decodeResource(getResources(), R.drawable.billdate),BitmapFactory.decodeResource(getResources(), R.drawable.billdate),"123456                                        08/2021");
      //  templatePDF.addImageLogo(BitmapFactory.decodeResource(getResources(), R.drawable.pos2));
  //      templatePDF.addImageTitle(BitmapFactory.decodeResource(getResources(), R.drawable.bill_title));
     //   templatePDF.addImageCompany(BitmapFactory.decodeResource(getResources(), R.drawable.company));
     //   templatePDF.addText(" 07/2021");
     //   templatePDF.addImageLogo2(BitmapFactory.decodeResource(getResources(), R.drawable.billdate),BitmapFactory.decodeResource(getResources(), R.drawable.billdate),"123456                                        08/2021");
