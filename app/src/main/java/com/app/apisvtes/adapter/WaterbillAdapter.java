...
public class WaterbillAdapter extends RecyclerView.Adapter<WaterbillAdapter.MyViewHolder> {
    ...
    public WaterbillAdapter(Context context, List<HashMap<String, String>> expenseData) {
    ...
    @NonNull
    @Override
    public WaterbillAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final WaterbillAdapter.MyViewHolder holder, int position) {
