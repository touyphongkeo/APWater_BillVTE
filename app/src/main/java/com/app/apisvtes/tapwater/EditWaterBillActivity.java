...
public class EditWaterBillActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_waterbill);
        try{
            ...
            try {
                    ...
                    productData1 = databaseAccess.getDatarate(strRate.toString());
            ...
            txtPrint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (strRate.equals("01")){
                        Intent intent = new Intent(EditWaterBillActivity.this, BillTestActivity.class);
                        startActivity(intent);
                        finish();
                    }else if(strRate.equals("02")){
                        Intent intent = new Intent(EditWaterBillActivity.this, BillTestsActivity.class);
                        startActivity(intent);
                        finish();
...
//*/
                                ...
                                if (check) {
                                    Toasty.success(EditWaterBillActivity.this, R.string.update_successfully, Toast.LENGTH_SHORT).show();
                        ...
                        Toasty.error(EditWaterBillActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
