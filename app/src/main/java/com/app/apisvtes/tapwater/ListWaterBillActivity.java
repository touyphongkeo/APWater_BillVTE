...
public class ListWaterBillActivity extends BaseActivity {
   ...
   // FloatingActionButton fabAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listwaterbill);
      ...
      //  fabAdd=findViewById(R.id.fab_add);
        ...
        gpsTracker = new GpsTracker(ListWaterBillActivity.this);
     ...
     //       txtLat.setText("lat:" + flatitude +" , long:"+flongitude);
        ...
        imgscancode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    DatabaseAccess databaseAccess = DatabaseAccess.getInstance(ListWaterBillActivity.this);
                    databaseAccess.open();
                    //get data from local database
                    String lt =flatitude.substring(0, 6);
                    String lng =flongitude.substring(0, 6);
                    List<HashMap<String, String>> searchExpenseList2;
                    searchExpenseList2 = databaseAccess.searchListWaterGPS(lt , lng,VillID);
                //  Toasty.info(ListWaterBillActivity.this, fstr, Toast.LENGTH_SHORT).show();
                    ...
                    if (searchExpenseList2.size() <= 0) {
                        ...
                        listWaterBillAdapter = new ListWaterBillAdapter(ListWaterBillActivity.this, searchExpenseList2);
        ...
        try {
           ...
           try {
                ...
                databaseAccess.open();
                productData = databaseAccess.searchListWater("",selectedCategoryID2.toString());
        ...
        etxtDistrict.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                categoryAdapter = new ArrayAdapter<String>(ListWaterBillActivity.this, android.R.layout.simple_list_item_1);
                categoryAdapter.addAll(categoryNames);

                AlertDialog.Builder dialog = new AlertDialog.Builder(ListWaterBillActivity.this);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                //  searchData(s.toString());
                    try{
                        ...
                        databaseAccess.open();
                        //get data from local database
                        searchExpenseList = databaseAccess.searchListWaterdfgdfgdg(s.toString());
                        if (searchExpenseList.size() <= 0) {
                            ...
                            recyclerView.setVisibility(View.VISIBLE);
                            imgNoProduct.setVisibility(View.GONE);
                            listWaterBillAdapter = new ListWaterBillAdapter(ListWaterBillActivity.this, searchExpenseList);
                            recyclerView.setAdapter(listWaterBillAdapter);
