package com.app.apisvtes.printrepay;
...
public class PrintTest2Activity extends AppCompatActivity {
    String txtKheiID="";
    String strBarcode="";
    TextView editText;
    ...
    TextView textfff,text33,txt_ZONEss,txt_Datess,txt_ACCOUNT,txt_NAME,
            ...
            text_Waters,textMrets,text_Taxs,textTotalBills,textDues,textTotals,bar_numbers,txtDateWarnings,text_TOTALDUE,TOTALDUE,txt_datepay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billtest3);
...
//        textSEWER1= views.findViewById(R.id.text_SEWER1);
       ...
       // txt_view9 = view1.findViewById(R.id.amontmoney);
        ...
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(PrintTest2Activity.this);
        databaseAccess.open();
...
//
                        ...
                        Double talo = Double.parseDouble(f2.format(s1g));
                        databaseAccess.open();
...
//                      txtConsumption.setText(productData.get(0).get("Consumption")+" ມ³");
                        ...
                        databaseAccess.open();
                        String tject = databaseAccess.getamotpay(CustID,billno);

                        Double dssf = Double.parseDouble(TOTALDUE1);
                        txt_view8.setText(f1.format(dssf));

                        databaseAccess.open();
                        String tject22 = databaseAccess.getTOTALDUESSsfdsdfsf(CustID,billno);
                        double v3 = Double.parseDouble(tject22);

                        double v1 = Double.parseDouble(tject);
                        double vb = dssf-v1;

                    //  String bvc = String.valueOf(vb);

                        text_TOTALDUE.setText(f1.format(vb));

                        TOTALDUE.setText(f1.format(v1));
    ...
    public void changeOnCon() {
        ...
        public void onClick(SweetAlertDialog sDialog) {
            try {
                Intent intent = new Intent(PrintTest2Activity.this, MenuActivity.class);
